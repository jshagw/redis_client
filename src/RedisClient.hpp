...
private:
    bool ConnectToRedis(const std::string &strHost, int nPort, int nTimeout, const std::string& strPassword);
    bool Reconnect();
...
public:
    CRedisServer(const std::string &strHost, int nPort, int nTimeout, int nConnNum, const std::string& password);
...
public:
    ...
    bool Initialize(const std::string &strHost, int nPort, int nTimeout, int nConnNum, const std::string &pass);
